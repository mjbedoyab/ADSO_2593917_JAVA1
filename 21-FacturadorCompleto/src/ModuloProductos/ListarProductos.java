...
public class ListarProductos extends javax.swing.JFrame {
    ...
    public ListarProductos(Menu ventanaMenu, String titulo) {
    ...
    public void initAlternComponents(){
        ...
        this.EtqTitulo.setText("LISTAR PRODUCTOS "+this.titulo);
    ...
    public void imprimirProductos(){
        Producto listaProductos[] = (this.titulo.equalsIgnoreCase("PRODUCTO")) ? this.ventanaMenu.database.listaProductos() : null;
