...
public class ModificarProductos extends javax.swing.JFrame {
    ...
    public ModificarProductos(Menu ventanaMenu, Producto [] listaProductos, String tipoLista) {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (temporal != null) {
            ...
            Alert alerta = new Alert("NO EXISTE", "El Id no está registrado.", "error");
            campoNombre.setText("");
            campoPrecio.setText("");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (!codigo.equals("") && !nombre.equals("") && !precio.equals("")) {
            ...
            boolean proceso = (this.tipoLista.equalsIgnoreCase("PRODUCTO"))? this.ventanaMenu.database.editarProductos(temporal) : false;
